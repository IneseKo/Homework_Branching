...
public class Third {
    public static void main(String[] args) {
        ...
        if (Day<1 || Day >31){
            System.out.println("Wrong data. Please rerun the Program and enter correct Day of the month");
            System.exit(0);
        }
        ...
        if (Month<1 || Month >12){
            System.out.println("Wrong data. Please rerun the Program and enter correct Month of the Year");
            System.exit(0);
        }
